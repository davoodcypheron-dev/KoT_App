      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
        ...
        >
          <div className="text-center mb-6">
            ...
            <h3 className="text-2xl font-black text-slate-800 tracking-tight">Table {table.id}</h3>
            <p className="text-slate-400 font-bold uppercase tracking-[0.2em] text-[8px] mt-1">Dine-in Guest Count</p>
          </div>
