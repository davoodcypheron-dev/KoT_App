...
const ItemAddonMaster = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#f0f4f7] overflow-hidden h-screen font-sans">
      <MasterNavPanel />
      ...
      <div className="flex-1 overflow-hidden p-2 flex gap-3 bg-[#f0f4f7]">
        ...
        <div className="flex-1 flex flex-col bg-white border border-slate-300 rounded-sm shadow-sm overflow-hidden">
          ...
          <div className="p-3 space-y-4 flex-1 flex flex-col overflow-hidden">
            ...
            <div className="grid grid-cols-12 gap-3 shrink-0">
              <div className="col-span-8 space-y-1.5">
                ...
                <div className="relative group">
                  <input
                    ...
                    className="w-full h-9 border border-slate-300 rounded-sm px-3 text-xs outline-none focus:border-blue-400 bg-white shadow-inner"
                  />
                  <AnimatePresence>
              ...
              <div className="col-span-4 space-y-1.5 flex flex-col items-center">
                ...
                <div className="flex items-center h-9 pr-2">
                  ...
                  <span className="ml-2 text-[9px] font-black text-slate-500 uppercase tracking-widest w-12">{status ? 'Active' : 'Inactive'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 flex-1 flex flex-col overflow-hidden">
               <div className="flex items-center justify-between shrink-0">
                  <label className="text-[11px] font-bold text-slate-600 uppercase tracking-tight">Step 2: Link Addons</label>
                  <div className="relative w-40">
                    ...
                    <input
                      ...
                      className="w-full h-7 border border-slate-300 rounded-sm pl-8 pr-2 text-[10px] font-bold outline-none focus:border-blue-400 bg-slate-50 shadow-inner"
                    />
                  </div>
               </div>
                  ...
                  <div className="flex-1 overflow-y-auto no-scrollbar">
                    <table className="w-full text-xs text-left border-collapse">
                      <thead className="bg-[#fcfdff] border-b border-slate-200 sticky top-0 bg-white">
                        <tr>
                          <th className="px-3 py-2 border-r border-slate-200 font-bold text-slate-700 w-10 text-center">
                            <Check size={14} className="mx-auto text-slate-400" />
                          </th>
                          <th className="px-3 py-2 border-r border-slate-200 font-bold text-slate-700 uppercase text-[9px]">Addon Name</th>
                          <th className="px-3 py-2 font-bold text-slate-700 uppercase text-[9px] text-right">Price</th>
                        </tr>
                      </thead>
                      <tbody>
            ...
            <table className="w-full text-xs text-left border-collapse">
              <thead className="bg-[#fcfdff] border-b border-slate-200 sticky top-0 bg-white shadow-sm">
                <tr>
                  ...
                  <th className="px-3 py-3 font-bold text-slate-700 w-16 text-center">Edit</th>
                </tr>
              </thead>
              <tbody>
